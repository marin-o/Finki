...
public class BubbleSortDLL {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        s = in.readLine();
        DLL<Integer> intList= new DLL<Integer>();
        String[] pom = s.split(" ");
        for ( String string: pom ) {
            intList.insertLast(Integer.parseInt(string));
        }

        DLLNode<Integer> node1=intList.getFirst();
        ...
        System.out.println(intList.toString().replace("<->"," "));
