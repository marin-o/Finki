...
enum Camera_Actions { FORWARD, BACKWARD, LEFT, RIGHT, JUMP, CROUCH };
...
const float GRAVITY_STRENGTH = 6.0f;
const float MIN_HEIGHT = 1.0f;
const float CROUCH_DEPTH = 0.1f;
const float CROUCH_SPEED = 10.0f;
...
public:
    ...
    void JumpState(bool jumpButtonState);
    void CrouchState(bool crouchButtonState);
