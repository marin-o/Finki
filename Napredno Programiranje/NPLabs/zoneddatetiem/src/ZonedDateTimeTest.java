...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        LocalDateTime ldt = LocalDateTime.of(2015,7,10,2,14,25);
        return ZonedDateTime.of(ldt,ZoneId.of("Asia/Tokyo"));
    }
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        return ZonedDateTime.parse("2015-06-18T23:07:25.000+10:00[Asia/Tokyo]");
    }
    ...
    static ZonedDateTime toPST() {
         ...
         */
        return ldt.atZone(ZoneId.of("PST",ZoneId.SHORT_IDS));
    }
    ...
    static ZonedDateTime sameInstantAs() {
         ...
         */
        return zdt.withZoneSameInstant(ZoneId.of("PST",ZoneId.SHORT_IDS));
    }
    ...
    static ZonedDateTime sameLocalAs() {
         ...
         */
        return zdt.withZoneSameLocal(ZoneId.of("PST",ZoneId.SHORT_IDS));
    }
