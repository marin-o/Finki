...
- Во класата `mk.ukim.finki.wp.exam.example.web.CandidatesController` се дефинирани сите методи кои се потребни за да се имплементира менаџирањето со кандидатите.
