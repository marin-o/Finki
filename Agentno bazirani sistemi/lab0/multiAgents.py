...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        """
        return self.max_value(gameState, 0, float('-inf'), float('inf'), 0)[1]
    ...
    def value(self, gameState, agentIndex, depth, alpha, beta):
        ...
        if agentIndex == 0:
            return self.max_value(gameState, agentIndex, alpha, beta, depth)[0]
        else:
            return self.min_value(gameState, agentIndex, alpha, beta, depth)[0]
...
class ExpectimaxAgent(MultiAgentSearchAgent):
    ...
    def value(self, gameState, agentIndex, depth):
        ...
        if agentIndex == 0:
            ...
            return self.exp_value(gameState, agentIndex, depth)[0]
    ...
    def exp_value(self, gameState, agentIndex, depth):
        ...
        for action in legal_actions:
            successor_state = gameState.generateSuccessor(agentIndex, action)
            v1 = self.value(successor_state, next_agent_index, depth)
            val += p * v1
        return val, None
